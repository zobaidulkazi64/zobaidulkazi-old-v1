...
const Contact: React.FC = () => {
  ...
  const notifySentForm: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    try {
      ...
      if (language === "BN") {
        toast.success(toastMessages.successEmailSent.bn);
      } else {
      ...
      console.log(error);
      if (language === "BN") {
        toast.error(toastMessages.failedEmailSent.bn);
      } else {
        ...
        >
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "BN" ? contactData.title.bn : contactData.title.en}
              <span className="text-[--orange]">/&gt;</span>
            </p>

            <h2 className="text-[--black] text-center">
              {language === "BN"
                ? contactData.description.bn
        ...
        <div className="flex flex-row justify-center items-start px-32 pt-32 mb-32 max-lg:flex-col max-lg:p-10">
          ...
          >
            ...
            <textarea
              ...
              placeholder={
                language === "BN"
                  ? `${contactData.textarea.placeholder.bn}`
            ...
            <div className="privacy-checkbox flex gap-16">
              ...
              <p>
                {language === "BN"
                  ? `${contactData.privacyOptIn.checkbox.bn}`
                  : `${contactData.privacyOptIn.checkbox.en}`}
              </p>
            </div>
            <p>
              {language === "BN"
                ? `${contactData.privacyOptIn.description.bn}`
                : `${contactData.privacyOptIn.description.en}`}
            </p>
            <Button
              value={
                language === "BN"
                  ? `${contactData.button.value.bn}`
